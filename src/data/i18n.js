...
export const EN = {
  ...
  'home.hero.sub':     `The plant has been something else for hours. Your shift manager
      has already made three calls by gut feel — and you find out tomorrow in the meeting.
      <br/><br/>
      <span class="hero__relief">Planning Core</span> keeps one plan alive: it catches the
      deviation and hands you three replanning scenarios — scored against hundreds of
  ...
  'home.proof.code':      'lines of code to get started',
  ...
  'home.replan.label': 'Reality changes',
  'home.replan.title': "Monday's optimal plan lasts<br/>until the first surprise.",
  'home.replan.sub':   'A breakdown, a rush order, a worker off sick. Planning Core catches the deviation and returns a new plan without breaking committed dates.',
  'home.replan.t0.tag':   'Monday · 08:00',
  'home.replan.t0.title': 'Optimal plan published',
  'home.replan.t0.desc':  'Balanced · 4/4 parts · OTD 100%',
  'home.replan.t1.tag':   'Monday · 14:07',
  'home.replan.t1.title': 'Breakdown on AUTOCLAVE-01',
  'home.replan.t1.desc':  '2 shifts out of service · 6 orders affected',
  'home.replan.t2.tag':   'Monday · 14:07 + 3 s',
  'home.replan.t2.title': 'Replanned',
  'home.replan.t2.desc':  '3 orders moved to the afternoon shift · OTD 96% · no broken dates',
  'home.replan.cta':      'See replanning in detail →',
  ...
  'home.value.2.desc':  'Autoclave cycle, maintenance windows, GxP traceability — pre-configured.',
  ...
  'prod.f2.li.1':       'Balanced: 1 shift of buffer — throughput and robustness',
